...
const sidebarLinks = [
  ...
  { label: "My Profile", href: "/pro/profile", icon: User },
  { label: "Portfolio", href: "/pro/portfolio", icon: Images },
  { label: "Services", href: "/pro/services", icon: Wrench },
  { label: "Quote Requests", href: "/pro/quotes", icon: FileText },
  { label: "My Projects", href: "/pro/projects", icon: FolderKanban },
  { label: "Earnings", href: "/pro/earnings", icon: DollarSign },
  { label: "Reviews", href: "/pro/reviews", icon: Star },
